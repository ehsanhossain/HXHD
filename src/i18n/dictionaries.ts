...
const en = {
  ...
  'sec.videoDispatch': 'Dispatch bay',
  'sec.videoStore': 'Bulk store',
  'sec.videoLoading': 'Loading for delivery',
  'sec.closeVideo': 'Close video',
...
const bn: Dict = {
  ...
  'sec.videoDispatch': 'ডিসপ্যাচ বে',
  'sec.videoStore': 'বাল্ক স্টোর',
  'sec.videoLoading': 'ডেলিভারির জন্য লোডিং',
  'sec.closeVideo': 'ভিডিও বন্ধ করুন',
