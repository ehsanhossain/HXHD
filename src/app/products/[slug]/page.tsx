    ...
    <div className="bg-white">
      ...
      <div className="bg-[var(--paper-2)] border-b border-[var(--line)]">
        <div className="shell py-3 text-xs text-[var(--steel)] flex flex-wrap items-center gap-1.5">
          ...
          <Link href="/products" className="hover:text-[var(--brand-red)] transition-colors">Products</Link>
          <span className="text-[var(--line-strong)]">/</span>
          <Link
      ...
      <div className="shell py-12 lg:py-16">
            ...
            <div className="flex flex-wrap items-center gap-3 mb-7">
              ...
              {product.rating && (
                <span className="inline-flex items-center gap-1.5 text-sm text-[var(--steel)]">
                  ...
                  <span className="tnum">({product.rating.count} reviews)</span>
                </span>
              )}
            </div>
        ...
        {product.body.length > 0 && (
          <Reveal className="mt-20 max-w-4xl">
            <h2 className="text-step-2 mb-2">Product description</h2>
        ...
        {product.specs.length > 0 && (
          <Reveal className="mt-20">
            <h2 className="text-step-2 mb-2">Technical data</h2>
            <div className="w-16 h-[5px] bg-[var(--brand-red)] mb-8" />
        ...
        {related.length > 0 && (
          <section className="mt-24">
            <Reveal>
              <h2 className="text-step-2 mb-2">More in {product.category}</h2>
              <div className="w-16 h-[5px] bg-[var(--brand-red)] mb-8" />
            </Reveal>
