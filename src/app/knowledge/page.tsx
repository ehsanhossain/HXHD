...
const QUICK_LINKS = [
  ...
  { label: 'Technical Library', icon: Library, href: '/products' },
];
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col flex-grow p-6">
        ...
        <p className="text-sm text-[var(--steel)] leading-relaxed mb-5">{article.summary}</p>
  ...
  return (
    <div className="bg-white">
      <PageHero
        ...
        intro={`${TECHNICAL_ARTICLES.length} technical guides on emulsion chemistry and selection, plus company updates — published by Hongxing Hongda.`}
        ...
        <div className="shell">
          <Reveal className="flex flex-wrap justify-between items-end gap-6 mb-12">
            <div className="max-w-2xl">
              <p className="eyebrow mb-5">Technical guides</p>
              <h2 className="text-step-3">Choosing and using emulsions</h2>
            </div>
      ...
      <section className="section bg-[var(--ink)] text-white relative overflow-hidden">
        ...
        <div className="shell relative">
          <Reveal className="max-w-2xl mb-14">
            <p className="eyebrow mb-6">Company timeline</p>
            <h2 className="text-step-3 mb-6">Milestones</h2>
      ...
      <section className="section bg-[var(--paper-2)] border-b border-[var(--line)]">
        <div className="shell">
          <Reveal className="max-w-2xl mb-12">
            <p className="eyebrow mb-5">Company updates</p>
            <h2 className="text-step-3">News from the group</h2>
          </Reveal>
      ...
      <section className="section">
        <div className="shell grid lg:grid-cols-2 gap-14 items-center">
          <Reveal>
            ...
            <h2 className="text-step-3 mb-5">Need a datasheet or SDS?</h2>
            <p className="text-[var(--ink-3)] leading-relaxed mb-8">
              Technical data for every catalogue product sits on its product page.
              For safety data sheets, certificates of analysis or export
              documentation, contact the team and mark your enquiry{' '}
