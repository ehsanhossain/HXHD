...
export const metadata: Metadata = {
  ...
  description:
    "Hubei Hongxing Hongda New Materials Co., Ltd. (HXHD) — R&D-driven manufacturer of polymer emulsions, waterproofing systems, architectural coatings, and functional chemical additives with multi-base production in China and Bangladesh.",
  ...
  keywords: [
    ...
    "Hubei Hongxing Hongda",
  ],
  authors: [{ name: "Hubei Hongxing Hongda New Materials Co., Ltd." }],
  creator: "HXHD",
  publisher: "Hubei Hongxing Hongda New Materials Co., Ltd.",
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "HXHD — Hubei Hongxing Hongda New Materials Co., Ltd.",
      },
    ],
  },
  twitter: {
