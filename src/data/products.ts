// AUTO-GENERATED from https://www.hxhdchemical.com — do not edit by hand.
// Source: product_sitemap.xml (28 products) + product_category_sitemap.xml (21 categories)
// Regenerate by re-running the scrape; see git history for the extraction script.
...
export interface Product {
  ...
  body: string[];
  /** Technical datasheet tables, most relevant first. */
  specs: SpecTable[];
  sourceUrl: string;
}
...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    "highlights": [
      "This emulsion is eco-friendly. It meets the requests of Chinese standard (JC1066-2008), and the water resistance is superior to the similar products in the market.",
      "The two component JS coating made from it has a long open time after being mixed. So more quantity of coatings can be mixed in one time to save time and labor.",
      "The emulsion has excellent bonding and adhesion with surface of building base. So It is easy to paint the building with the coatings made from this emulsion. Moreover it’s also easy to repair and the waterproof membrane.",
      "The emulsion has excellent leveling performance and it won’t flow down on the vertical wall. it can painted on the wet base.",
      "Because of excellent weather resistance, heat resistance and UV resistance, this emulsion is widely used to produce different waterproof coatings for building roof, wall, kitchen and bathroom."
    ],
    "body": [
      "It is weather resistant, heat resistant, ageing resistant, UV resistant and its elongation is high. With good elasticity and flexibility ,it able to adapt to some deformation within limited degree because of cracking.The waterproof membrane will not be broken because of the slight cracking of base surface. So the membrane can keep waterproofing. This emulsion has good compatibility with pigment and other powders. So the pigments can be added into waterproof coatings to get the customized color for customers to decorate their building. The waterproof coating made from it has combined function of decoration and waterproofing.",
    ...
    "specs": [
      ...
      },
      {
        ...
        "rows": [
          ...
          [
            "Tensile strength（STD ≥ 1.2Mpa）",
            "2.3",
            "2.42",
            "2.39"
          ],
          [
            "Elongation at break（STD ≥ 200%)",
            "123",
            "138",
            "129"
          ],
          [
            "Low temperature flexibility(radius 10mm rod）",
            "-10℃ No cracks"
          ],
          [
      ...
      {
        "headers": [
          "400JS- Ⅱ Type recommended formula"
        ],
        "rows": [
          [
            "Material name",
      ...
      {
        "headers": [
          "400JS- Ⅰ Type recommended formula"
        ],
        "rows": [
          [
            "Material name",
  ...
  },
  {
    ...
    "highlights": [],
    "body": [
      "HX-416A Emulsion features an internal plasticizing system that not only balances tensile strength and elongation but also delivers outstanding water resistance, alkali resistance, and UV resistance. The added active matter can penetrate into the base with water, and plugging capillary tubes to improve the adhesion between the coating and the substrate. This means that your waterproof coatings will not only withstand the elements but also maintain their integrity for the long haul. Say goodbye to worrying about water damage, deterioration from exposure to harsh chemicals, or degrading under the sun's UV rays. With the HX-416A Emulsion, your coatings will stay strong and resilient.",
      "What sets HX-416A Emulsion apart from other products on the market is the added active factor that enables it to penetrate into the base course with water. This unique capability allows the emulsion to effectively plug capillary pores, improving adhesion and enhancing overall waterproofing performance. You can trust that your coatings will form a reliable barrier against moisture, preventing leaks and water damage in a wide range of applications.",
      "In addition to its exceptional waterproofing capabilities, the HX-416A Emulsion is also designed to be easy to use. Its single-component formulation means that you can apply it with ease, saving time and effort during the coating process. Plus, its non-cement-based composition makes it a more environmentally friendly choice compared to traditional cementitious coatings. With the HX-416A Emulsion, you can achieve outstanding results without compromising on sustainability.",
      "Formula of high elastic acrylic thick coat waterproof coating",
      "High elastic acrylic thick coat waterproof coating",
      "Excellent water resistance, alkali resistance, UV resistance, Weather resistance, Good permeability, Good adhesion, Plasticizer-free, Suitable for simple formula",
      "HX-416 is acrylate styrene copolymer emulsion.This specially formulated emulsion is designed for flexible waterproof coating, making it an excellent choice for a variety of applications. Whether you're in need of a single component acrylic waterproof coating or a two-component cement-based waterproof coating, the HX-416 has got you covered."
    ],
    "specs": [
      {
      ...
      {
        "headers": [
          "High elastic acrylic thick coat waterproof coating test result"
        ],
        "rows": [
          [
            "Test items",
          ...
          [
            "Tensile strength（STD ≥ 1.0Mpa）",
            "1.87",
            "2.03",
            "2.08"
          ],
          [
            "Elongation at break（STD ≥ 300%)",
            "340",
            "335",
            "321"
          ]
  ...
  },
  {
    ...
    "keywords": [
      ...
      "High-quality paint for interiors",
      "Washable wall paint",
    ...
    "body": [
      ...
      "Good load carrying capacity, excellent brushing performance.",
      "Packing and storage The package is 50kg 160kg or 1000kg plastic drum. Storage tanks should be corrosion resistant. This product should be stored in unopened container in a ventilated cool and dry place, avoid exposing to direct sunlight.The proper environment temperature for its transportation and storage is between 5 and 35℃. Storage at higher temperature or high humidity may reduce shelf life.",
      "It is a high-performance coating solution designed for high-end Stone like paints, colorful paints, and finishes. This innovative emulsion offers exceptional aging resistance and yellowing resistance, making it a top choice for premium quality paint projects.",
      "HX-66 is anti-alkali emulsion,copolymerized by acrylates and functional monomers,modified acrylic polymer,single component. With small particle size and good penetrating performance, after film formation, it is water resistant, alkali resistant, with good adhesion and sealing capacity.",
      "This product is suitable for producing various exterior and interior wall sealing primer, and interface adhesion agent for extruded board for wall thermal insulation etc.",
      "HX-302G is a revolutionary modified styrene acrylate polymer that is single component and offers exceptional performance for a variety of applications. This high-quality product is mainly used in the production of high gloss waterborne paint, exterior wall paint, and the coating of SBS asphalt coiled material.",
      "It incorporates the most advanced wetting and late-stage reaction technology with powders. This innovative formula allows the emulsion and various powders to be seamlessly integrated into one, forming a denser film that provides superior protection and longevity.",
      "This innovative emulsion boasts small particle size, moderate viscosity, and a hard coating film, making it an ideal choice for a wide range of applications."
    ],
    "specs": [
      {
        ...
        "rows": [
          [
            ...
            "500-3000",
            "7-9",
            "Economical interior and exterior wall coating, medium and low-grade exterior wall coating"
          ]
        ]
      }
    ],
    "sourceUrl": "https://www.hxhdchemical.com/acrylic-and-styrene-architectural-emulsion-hx302-for-exterior-and-interior-wall-coating/"
  },
  {
    "id": "acrylic-and-styrene-architectural-emulsion-hx302-for-fast-drying-exterior-and-interior-wall-coating",
    ...
    "highlights": [],
    "body": [
      "It is water resistant, scrub resistant and alkali resistant. Moreover it has excellent stability for calcium ion,ensuring consistent performance under various conditions. It is also stable when it is diluted. It has mechanical stability, so when it is used to produce coatings and paints, the polymer emulsion is not destroyed if it is stirred by stirring machine at high spreed with huge impact force, that is, Molecular formula of styrene acrylic polymer is not broken. And it has freeze-thaw stability. The coating film or paint film won’t be broken or crack because of being frozen and thawing. This makes it a popular choice for the preparation of various interior and exterior wall coatings.",
      "It can also be used in coatings and adhesives. Only in cold season, appropriate quantity of film formation additive need to be added.",
      "Low cost, anti-resticking, fast drying speed for the coating film.",
      "HX-302G is a revolutionary modified styrene acrylate polymer that is single component and offers exceptional performance for a variety of applications. This high-quality product is mainly used in the production of high gloss waterborne paint, exterior wall paint, and the coating of SBS asphalt coiled material.",
      "It incorporates the most advanced wetting and late-stage reaction technology with powders. This innovative formula allows the emulsion and various powders to be seamlessly integrated into one, forming a denser film that provides superior protection and longevity.",
      "HX-66 is anti-alkali emulsion,copolymerized by acrylates and functional monomers,modified acrylic polymer,single component. With small particle size and good penetrating performance, after film formation, it is water resistant, alkali resistant, with good adhesion and sealing capacity.",
      "This product is suitable for producing various exterior and interior wall sealing primer, and interface adhesion agent for extruded board for wall thermal insulation etc.",
  ...
  },
  {
    ...
    "images": [
      ...
      "/images/catalog/e8e4777a353e.jpg"
    ],
    "rating": {
      "value": 5,
      "count": 294
    ...
    "body": [
      ...
      "Small particle size, good hardness and strong sealing capacity.",
      "HX-302G is a revolutionary modified styrene acrylate polymer that is single component and offers exceptional performance for a variety of applications. This high-quality product is mainly used in the production of high gloss waterborne paint, exterior wall paint, and the coating of SBS asphalt coiled material.",
      "HX-305 is pure acrylic emulsion, single component.",
      "It is a high-performance coating solution designed for high-end Stone like paints, colorful paints, and finishes. This innovative emulsion offers exceptional aging resistance and yellowing resistance, making it a top choice for premium quality paint projects.",
      "HX-300 is new styrene acrylic polymer emulsion made from high-quality raw materials and additives.",
      "This innovative emulsion boasts small particle size, moderate viscosity, and a hard coating film, making it an ideal choice for a wide range of applications.",
      "HX-302 is styrene acrylic copolymer emulsion,single component.",
      "This revolutionary product has been designed and engineered to deliver superior dry and wet adhesion of the coating film, making it an absolute game-changer in the industry.",
      "One of the key features of HX-302 is its unmatched scrub resistance, which is significantly higher than that of ordinary styrene acrylic emulsion.",
      "HX-303 emulsion is our latest breakthrough in interior and exterior wall paint technology.This revolutionary new product is super resistant to scrubbing and wet and dry discoloration, making it perfect for high-traffic areas that require a durable and long-lasting finish.",
      "It incorporates the most advanced wetting and late-stage reaction technology with powders. This innovative formula allows the emulsion and various powders to be seamlessly integrated into one, forming a denser film that provides superior protection and longevity."
    ],
    "specs": [
      {
